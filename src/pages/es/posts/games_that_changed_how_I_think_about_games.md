...
![thewitness1](/images/post_images/3.jpg)

Al principio parece bastante estándar. Completas la primera zona resolviendo algunos laberintos básicos y luego tienes acceso a toda la isla para explorar libremente. Sin embargo, justo al salir de la zona inicial, te golpea la revelación de que estos puzles de líneas tienen mucho, mucho más de lo que parecía.
...
<div style="display: flex; gap: 1rem; align-items: flex-start;">
	<img src="/images/post_images/5.jpg" alt="thewitness3" style="width: calc(50% - 0.5rem); height: auto;" />
	<img src="/images/post_images/6.jpg" alt="thewitness4" style="width: calc(50% - 0.5rem); height: auto;" />
</div>

Nunca había completado un juego al 100% antes de *The Witness*, pero el placer de explorar y aprender sus mecánicas me llevó a completar todos los paneles, puzles ambientales, coleccionables, desafíos y secretos del juego. ¿La recompensa? Absolutamente nada, salvo la diversión del camino.
...
La puerta final hacia el norte, a la Habitación 46, sigue cerrada. Para abrirla, necesitas activar otra palanca secreta en algún otro lugar. El juego sugiere fuertemente que probablemente está en el sótano, especialmente porque el *Antechamber* contiene una llave grande llamada _llave del sótano_. La estrategia pasa entonces por encontrar el *Coat Check*, una habitación que permite guardar un objeto entre partidas, y usarla para conservar la llave del sótano hasta descubrir cómo llegar allí.
...
![blueprince3](/images/post_images/9.jpg)

Si registras todas esas letras, obtienes el siguiente mensaje:
...
<div style="display: flex; gap: 1rem; align-items: flex-start;">
	<img src="/images/post_images/10.jpg" alt="blueprince4" style="width: calc(50% - 0.5rem); height: auto;" />
	<img src="/images/post_images/11.webp" alt="blueprince5" style="width: calc(50% - 0.5rem); height: auto;" />
</div>

Si volvemos a la pista —If we count small gates, eight dates crack eight safes— podemos inferir que hay que contar los “gaits” más pequeños de las pinturas. Hay quince del más pequeño y cuatro del siguiente. Como la pista indica que los códigos son fechas, 15/04 es la solución lógica.
...
<div style="display: flex; gap: 1rem; align-items: flex-start;">
	<img src="/images/post_images/12.jpg" alt="outerwilds1" style="width: calc(50% - 0.5rem); height: auto;" />
